...
VG_REGPARM(3) void TNT_(h32_put)      ( IRStmt *, UInt, UInt );
VG_REGPARM(3) void TNT_(h32_puti)     ( UInt, UInt, UInt, UInt );
VG_REGPARM(3) void TNT_(h32_unop)     ( IRStmt *, UInt, UInt );
...
VG_REGPARM(3) void TNT_(h64_put)      ( IRStmt *, ULong, ULong );
VG_REGPARM(3) void TNT_(h64_puti)     ( ULong, ULong, ULong, ULong );
VG_REGPARM(3) void TNT_(h64_unop)     ( IRStmt *, ULong, ULong );
