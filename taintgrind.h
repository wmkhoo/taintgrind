...
typedef enum {
	...
	VG_USERREQ__TAINTGRIND_MAKE_MEM_TAINTED_NAMED,
...
#define TNT_MAKE_MEM_TAINTED_NAMED(addr, size, varname) \
		VALGRIND_DO_CLIENT_REQUEST_STMT(VG_USERREQ__TAINTGRIND_MAKE_MEM_TAINTED_NAMED,addr,size,varname,0,0); \
